package com.deffe.max.vision.cloudtextrecognition;

import android.support.annotation.NonNull;
import android.util.Log;

import com.deffe.max.vision.FrameMetadata;
import com.deffe.max.vision.GraphicOverlay;
import com.deffe.max.vision.VisionProcessorBase;
...
public class CloudDocumentTextRecognitionProcessor extends VisionProcessorBase<FirebaseVisionCloudText> {

  private static final String TAG = "CloudDocuTextRecProcess";
